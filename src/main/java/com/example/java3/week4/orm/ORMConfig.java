...
//        //select student0_.id as id1_0_0_, student0_.name as name2_0_0_ from student student0_ where student0_.id=?
//        Student student = em.find(Student.class, "17");
//        /*
//            select teacher_st0_.s_id as s_id2_2_0_, teacher_st0_.id as id1_2_0_, teacher_st0_.id as id1_2_1_, teacher_st0_.s_id as s_id2_2_1_, teacher_st0_.t_id as t_id3_2_1_
//            from teacher_student teacher_st0_ where teacher_st0_.s_id=?
//         */
//        List<Teacher_Student> list = student.getTeacher_students();
//        System.out.println("------------------------");
//        list.size();

//        Query query = em.createQuery("select s from Student s join fetch s.teacher_students where s.id = ?1");
